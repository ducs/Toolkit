...
namespace Toolkit.Views.Component
{
    public abstract class ItemsPageBase : Page, INotifyPropertyChanged
    {
        ...
        private IEnumerable<PageInfoDate> _items;

        public IEnumerable<PageInfoDate> Items
        {
            get { return _items; }
        ...
        protected void OnItemGridViewItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            var item = (PageInfoDate)e.ClickedItem;
        ...
        protected async void OnItemGridViewLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                var gridView = (GridView)sender;
                var items = gridView.ItemsSource as IEnumerable<PageInfoDate>;
